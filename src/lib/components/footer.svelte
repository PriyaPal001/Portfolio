<div class="mt-0 border-t border-gray-100 p-6 sm:flex sm:items-center sm:justify-between bg-black">
	<p class="text-center text-sm text-white sm:text-left">
		<!-- Copyright &copy; 2022. All rights reserved. -->
        <a href="/" class="font-bold hover:underline">Priya Bidyut Pal</a>
	</p>
